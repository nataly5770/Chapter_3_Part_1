...
public class MonetaryUnits_3_7 {
    public static void main(String[] args) {
        ...
        //Ask user to insert the amount
        System.out.print("Enter the amount in double, for example 34,15: ");
        ...
        System.out.println(" " + numberOfDollars + (numberOfDollars == 1 ? " pennie": " pennies"));
